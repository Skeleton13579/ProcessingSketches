...
void setup() {
  ...
  PImage friends = loadImage("DanTDM.jpg");  // 2. Change this to match the name of your photo. 
...
background (friends);
  ...
  mustache = loadImage("Space Stache.png"); // 5. Change this to match your file name.
}
